...
public class Graph {
    ...
    /**
     * This method adds a new GraphNode to the Graph if it's not already in the graph, gives it an GraphID and returns it.
     * However,if the GraphNode already exists, it will return it's GraphID<p>
     * If a GraphNode matching the input is found but the duration and cost differ from 0, then both are updated
     * (This happens because to establish dependencies we use a dummy node with duration and cot set to 0)
     **/
    ...
    /**
     * This method returns GraphNode that contains de deliverable node with the typed value
     **/
    ...
    /**
     * The following method returns the sum of all costs of the nodes in the graph
     **/
